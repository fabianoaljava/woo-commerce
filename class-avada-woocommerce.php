...
class Avada_Woocommerce {
	...
	public function before_cart_table( $args ) {
		...
		<div class="woocommerce-content-box full-width clearfix">
				...
				<h2><?php printf( esc_attr( _n( 'Você possui %d item em seu carrinho', 'Você possui %s itens em seu carrinho', $woocommerce->cart->get_cart_contents_count(), 'Avada' ) ), number_format_i18n( $woocommerce->cart->get_cart_contents_count() ) ); // WPCS: XSS ok. ?></h2>
			<?php
	}
