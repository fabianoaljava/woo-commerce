...
/*
Path: wp-content/plugins/fusion-builder/shortcodes/
Changed by Fabiano Carvalho (https://github.com/fabianoaljava)
*/
		...
		class FusionSC_Login extends Fusion_Element {
			...
			public function render_login( $args, $content = '' ) {
				...
				if ( ! is_user_logged_in() ) {
					...
					$html .= '<div class="fusion-login-caption">' . sprintf( esc_html__( 'Olá %s você está logado.', 'fusion-builder' ), ucwords( $user->display_name ) ) . '</div>';
					...
					$html .= '<li><a href="/minha-conta/certificados">' . esc_html__( 'Dashboard', 'fusion-builder' ) . '</a></li>';
					$html .= '<li><a href="' . get_edit_user_link( $user->ID ) . '">' . esc_html__( 'Meu Perfil', 'fusion-builder' ) . '</a></li>';
					$html .= '<li><a href="' . wp_logout_url( get_permalink() ) . '">' . esc_html__( 'Sair', 'fusion-builder' ) . '</a></li>';
					$html .= '</ul>';
